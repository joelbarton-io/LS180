...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: joelbarton
--
...
ALTER TABLE public.weather OWNER TO joelbarton;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: joelbarton
--
